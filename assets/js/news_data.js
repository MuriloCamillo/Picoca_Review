...
const newsData = {
    ...
    <p>Aqui vai o primeiro parágrafo da notícia sobre Over the Garden Walldadadadadadad...</p>
    ...
    <div class="text-center my-4">
        <div class="ratio ratio-16x9 mx-auto" style="max-width: 640px;">
            <img src="assets/img/journal_news/overthegardenwall2.webp"
                 alt="Outra imagem de OTGW"
                 class="rounded news-image-in-ratio">
        </div>
        <p class="img-leg">Legenda da imagem secundária.</p>
    </div> 
    <h5>Uma frase de Efeito em um negrito, mas menor que o outro</h5>
    <p>Mais um parágrafo aqui, continuando a notícia...</p>
`,
    },
    'saul-final-season': {
        ...
        articleContent: `
            <h3>Nota 9+ em Todos os Episódios Finais</h3>
            <p>A aclamada série "Better Call Saul"...</p>
            <p>A jornada de Jimmy McGill...</p>
            <h5>O Legado de Albuquerque</h5>
            <p>A série não apenas expandiu...</p>
            <p>Se você ainda não viu...</p>
        `,
    },
    'flow-oscar': {
        ...
        articleContent: `
            ...
            <p>O filme de animação "Flow"...</p>
            <p>Além da beleza visual...</p>
            <h5>Quebrando Superstições</h5>
            <p>Ao apresentar um protagonista felino preto...</p>
        `,
    },
    'mickey17-critic': {
        ...
        articleContent: `
            <h3>Uma crítica futurística atual</h3>
            <p>O filme estrelado por Robert Pattinson...</p>
            <p>A narrativa é envolvente...</p>
            <h5>Uma Direção Precisa</h5>
            <p>Bong Joon-ho, conhecido por sua habilidade...</p>
        `,
    },
    'oscar-brasileiro': {
        ...
        articleContent: `
            <h3>Uma Vitória Esperada</h3>
            <p>O Brasil finalmente conquistou seu primeiro Oscar...</p>
            <p>A vitória foi recebida com aplausos...</p>
            <h5>Um Legado Duradouro</h5>
            <p>O filme não apenas conquistou prêmios...</p>
        `,
    },
    'stranger-things': {
        ...
        articleContent: `
            <h3>Uma Viagem no Tempo</h3>
            <p>A série "Stranger Things"...</p>
            <p>O crescimento dos personagens...</p>
            <h5>Nostalgia e Identificação</h5>
            <p>A série trouxe uma mistura de nostalgia...</p>
        `,
    }
};
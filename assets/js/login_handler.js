document.addEventListener('DOMContentLoaded', () => {
    const loginForm = document.querySelector('.formulario-login form.needs-validation'); // Seleciona o form com a classe
    ...
    if (loginForm && emailInput && passwordInput && generalErrorMessage) {
        ...
        console.error("Erro crítico: Formulário de login (.needs-validation), input de email/senha ou div de erro geral não encontrado(s) em login.html. Verifique os IDs e a estrutura HTML.");
    }
});
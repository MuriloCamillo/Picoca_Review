...
const seriesData = {
  ...
  'fmab': {
    ...
    tagline: "A alquimia é uma ciência.",
  ...
  'juri': {
    ...
    tagline: "Um reality show de tribunal.",
    ...
    status: "Finalizada.",
    statusClass: "status-ended",
    cast: ["Ronald Gladden", "James Marsden", "Eddie Pepitone"],
    genres: ["Comédia"],
    seasons: ["1ª Temporada - 8 episódios"],
    watchPlatforms: ["Prime Video"],
  ...
  'saul': {
    ...
    tagline: "A história de um advogado.",
  ...
  'spyxfamily': {
    ...
    status: "Renovada para 3ª Temporada.",
    statusClass: "status-renewed",
    cast: ["Takuya Eguchi", "Toshiyuki Morikawa", "Takuya Yaguchi"],
  ...
  'the_office': {
    ...
    genres: ["Comédia"],
    seasons: ["1ª Temporada - 6 episódios", "2ª Temporada - 22 episódios", "3ª Temporada - 23 episódios", "4ª Temporada - 14 episódios", "5ª Temporada - 28 episódios", "6ª Temporada - 26 episódios", "7ª Temporada - 22 episódios", "8ª Temporada - 24 episódios", "9ª Temporada - 25 episódios"],
    watchPlatforms: ["Peacock", "Netflix", "Prime Video", "HBO Max"],
